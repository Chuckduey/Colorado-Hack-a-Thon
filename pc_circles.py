...
# Define Tk root
root = tk.Tk()
canvas = tk.Canvas(root, width=screen_width, height=screen_height+100, borderwidth=0, highlightthickness=0, bg="#27272d")
canvas.grid()
...
canvas.create_line(center_x,100,center_x,screen_height+100,fill="#7d7d81")
...
mag_block=canvas.create_text(15,110,fill="white",font="Times 15",text="Mag = 1.2", anchor="w")
ph_block=canvas.create_text(282,110,fill="white",font="Times 15",text="Phase = 180.0", anchor="w")
logo = tk.PhotoImage(file='Keysight_Logo.PNG')
canvas.create_image(30,5,image=logo, anchor="nw")
# Start main loop
